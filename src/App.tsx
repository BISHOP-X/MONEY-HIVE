...
// Simple Routes - no animation overhead for instant navigation
function AppRoutes() {
  return (
    <Routes>
      {/* ============================================
      ...
      {/* ============================================
          ...
          In public mode: redirects to /
          In preview mode: requires mock auth
          ============================================ */}
 ...
 *   - Access via ?preview=moneyhive2024
 *   - Must login via mock auth to access protected pages

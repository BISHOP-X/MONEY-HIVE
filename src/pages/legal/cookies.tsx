    ...
    <main className="flex min-h-screen flex-col bg-slate-50 dark:bg-slate-900">
      ...
      <div className="flex-grow">
        <div className="max-w-4xl mx-auto px-4 pt-28 pb-16">
          <h1 className="text-4xl font-bold mb-8 text-secondary dark:text-foundation-light">Cookie Policy</h1>
          ...
          <div className="prose prose-lg dark:prose-invert">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-secondary dark:text-foundation-light">1. What Are Cookies</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-secondary dark:text-foundation-light">2. Types of Cookies We Use</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-secondary dark:text-foundation-light">3. Managing Cookies</h2>
            <p className="text-secondary/80 dark:text-foundation-light/80">
              You can control and/or delete cookies as you wish. You can delete all cookies that are already on your computer and you can set most browsers to prevent them from being placed.
            </p>

            <h2 className="text-2xl font-semibold mt-8 mb-4 text-secondary dark:text-foundation-light">4. Third-Party Cookies</h2>
            <p className="text-secondary/80 dark:text-foundation-light/80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-secondary dark:text-foundation-light">5. Updates to This Policy</h2>
            <p className="text-secondary/80 dark:text-foundation-light/80">

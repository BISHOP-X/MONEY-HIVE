    ...
    <main className="flex min-h-screen flex-col bg-coconut-milk dark:bg-midnight-ash">
      ...
      <div className="pt-20 flex-grow">
        <div className="max-w-4xl mx-auto px-4 py-16">
          <h1 className="text-4xl font-bold mb-8 text-midnight-ash dark:text-coconut-milk">Terms of Service</h1>
          ...
          <div className="prose prose-lg dark:prose-invert">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-midnight-ash dark:text-coconut-milk">1. Agreement to Terms</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-midnight-ash dark:text-coconut-milk">2. Use License</h2>
            <p className="text-midnight-ash/80 dark:text-coconut-milk/80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-midnight-ash dark:text-coconut-milk">3. Service Description</h2>
            <p className="text-midnight-ash/80 dark:text-coconut-milk/80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-midnight-ash dark:text-coconut-milk">4. User Obligations</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-midnight-ash dark:text-coconut-milk">5. Fees and Charges</h2>
            <p className="text-midnight-ash/80 dark:text-coconut-milk/80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-midnight-ash dark:text-coconut-milk">6. Limitation of Liability</h2>
            <p className="text-midnight-ash/80 dark:text-coconut-milk/80">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-midnight-ash dark:text-coconut-milk">7. Changes to Terms</h2>
            <p className="text-midnight-ash/80 dark:text-coconut-milk/80">
